...
if useDataSet
    ...
    [hyperplane counters] = bagging(dataSet,NBags,ratio);
    hyperplane
    ...
    for kRun=1:NRuns
        ...
        [hyperplane counters] = bagging(dataSetCV,NBags,ratio);
        hyperplane
    end
    ...
    [hyperplane counters] = bagging(Z,NBags,ratio)
